...
acc_dynamics = sklearn.metrics.accuracy_score(s_prime_test, s_a_pred)
acc_reward = sklearn.metrics.accuracy_score(r_test, reward_pred)
print("Accuracy for dynamics model: {}".format(acc_dynamics))
print("Accuracy for reward model: {}".format(acc_reward))
